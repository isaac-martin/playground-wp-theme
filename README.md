# Playground Theme (weareplayground.co)

Powerful shell built for rapidly deploying Client WordPress projects. Based upon Bootstrap and Todd Mottos HTML5 Blank.

* Website: [Playground](http://weareplayground.co)
* Author : [Isaac Martin](http://isaacmartin.co) // [@isaacmartin23](http://twitter.com/isaacmartin23)
